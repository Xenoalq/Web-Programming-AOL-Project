...
<div class="container">
    ...
    <form method="POST" action="{{ route('admin.live.store') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('live_title') is-invalid @enderror" id="live_title" name="live_title" value="{{ old('live_title') }}" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('live_artist') is-invalid @enderror" id="live_artist" name="live_artist" value="{{ old('live_artist') }}" required>
        ...
        <div class="mb-3">
            ...
            <input type="url" class="form-control @error('stream_url') is-invalid @enderror" id="stream_url" name="stream_url" value="{{ old('stream_url') }}" required>
